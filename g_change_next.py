...
remove_exact = [
    ...
    "家電量販店", "建築会社", "ハウス クリーニング業", "焼肉店",
    "建築設計事務所", "左官", "作業服店", "空調設備工事業者", "金属スクラップ業者",
    "害獣駆除サービス", "モーター修理店", "アーチェリーショップ", "アスベスト検査業",
    "事務用品店", "測量士", "配管業者", "労働組合", "ガス会社", "ガソリンスタンド",
    "ガラス/ミラー店", "ワイナリー", "屋根ふき業者", "高等学校", "金物店", "史跡",
    "商工会議所", "清掃業", "清掃業者", "配管工", "お手頃"
]
...
if uploaded_files:
    for file_index, uploaded_file in enumerate(uploaded_files):
        ...
        # ===============================
        # template.xlsx へ書き込み（開拓先リストの書式を保持）
        # ===============================
        ...
        # ★ 既存データの一括クリアは行わず、B〜E列に必要分だけ上書きする
